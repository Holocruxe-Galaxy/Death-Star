  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="48" viewBox="0 0 48 48" fill="none">
      <g filter="url(#filter0_d_849_49813)">
        <path d="M15.0957 18.6924L4.50195 8.09863L16.9707 0.317383L28.502 8.09863L15.0957 18.6924Z" fill="#FF8A65" />
        <path d="M15.0957 18.6924L4.50195 8.09863L8.5332 3.12988L28.502 8.09863L15.0957 18.6924Z" fill="#FFAB91" />
        <path
