  ...
  return (
    ...
    >
      <svg
        ...
        className={`${styles.svg} ${activeSvg ? styles.active : ''}`}
      >
        <g filter="url(#filter0_d_22_7122)" className={`${styles.svg} ${activeSvg ? styles.active : ''}`}>
          <path
        ...
        <g filter="url(#filter1_d_22_7122)" className={`${styles.svg} ${activeSvg ? styles.active : ''}`}>
          <path
