  ...
  return (
    <Grid container spacing={6} className="match-height">
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Show an alert to the user to convey something or make the user
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            You can also use any of the transitions that you like. Use{' '}
            <code>TransitionComponent</code> prop for the transition.
          </Typography>
          <DialogTransition />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            You can customize the component the way you want using{' '}
            <code>styled</code> hook.
          </Typography>
          <DialogCustomized />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Add <code>fullScreen</code> prop with <code>Dialog</code> component
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Make a full screen dialog at particular screen sizes only by using{' '}
            <code>useMediaQuery</code> hook.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>disableEscapeKeyDown</code> prop to disable 'Escape' key
            and use <code>onClose</code> prop to disable the backdrop.
          </Typography>
          <DialogConfirmation />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            <code>scroll=paper</code> scrolls within the paper element and{' '}
            <code>scroll=body</code> scrolls within the body element.
          </Typography>
          <DialogsScroll />
        </CardSnippet>
      </Grid>
