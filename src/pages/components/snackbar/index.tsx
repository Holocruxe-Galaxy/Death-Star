  ...
  return (
    <Grid container spacing={6} className="match-height">
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>open</code> prop with <code>Snackbar</code> component
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Add <code>Alert</code> component as a children of{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use <code>anchorOrigin</code> prop to change the position of the
            snackbar.
          </Typography>
          <SnackbarPositioned />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            When multiple snackbar updates are necessary, they should appear one
            at a time.
          </Typography>
          <SnackbarConsecutive />
        </CardSnippet>
