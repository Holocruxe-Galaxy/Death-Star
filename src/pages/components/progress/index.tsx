    ...
    <Grid container spacing={6} className="match-height">
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="Indeterminate"
          code={{
            tsx: source.ProgressCircularIndeterminateTSXCode,
            jsx: source.ProgressCircularIndeterminateJSXCode,
          }}
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>CircularProgress</code> component for simple circular
            progress.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="Colors"
          code={{
            tsx: source.ProgressCircularColorsTSXCode,
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="With label"
          code={{
            tsx: source.ProgressCircularWithLabelTSXCode,
            jsx: source.ProgressCircularWithLabelJSXCode,
          }}
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant='determinate'</code> and <code>value</code> props
            with the help of a state for circular progress with label.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="Customization"
          code={{
            tsx: source.ProgressCircularCustomizationTSXCode,
      ...
      <Grid item xs={12}>
        <CardSnippet
          ...
          code={{
            tsx: source.ProgressCircularControlledUncontrolledTSXCode,
            jsx: source.ProgressCircularControlledUncontrolledJSXCode,
          }}
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>value</code> prop with the help of a state for
            controlled circular progress.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="Indeterminate"
          code={{
            tsx: source.ProgressLinearIndeterminateTSXCode,
            jsx: source.ProgressLinearIndeterminateJSXCode,
          }}
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>LinearProgress</code> component for simple linear
            progress.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="Buffer"
          code={{
            tsx: source.ProgressLinearBufferTSXCode,
            jsx: source.ProgressLinearBufferJSXCode,
          }}
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant='buffer'</code> and <code>valueBuffer</code> props
            with the help of a state for linear progress with buffer.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="Colors"
          code={{
            tsx: source.ProgressLinearColorsTSXCode,
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="Controlled and Uncontrolled"
          code={{
            tsx: source.ProgressLinearControlledUncontrolledTSXCode,
            jsx: source.ProgressLinearControlledUncontrolledJSXCode,
          }}
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>value</code> prop with the help of a state for
            controlled linear progress.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="With Label"
          code={{
            tsx: source.ProgressLinearWithLabelTSXCode,
            jsx: source.ProgressLinearWithLabelJSXCode,
          }}
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant='determinate'</code> and <code>value</code> props
            with the help of a state for linear progress with label.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        <CardSnippet
          title="Customization"
          code={{
            tsx: source.ProgressLinearCustomizationTSXCode,
