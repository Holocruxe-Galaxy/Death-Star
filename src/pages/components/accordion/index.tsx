  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>Accordion</code>, <code>AccordionSummary</code> and{' '}
            <code>AccordionDetails</code> components to make a simple accordion.
          </Typography>
          <AccordionSimple />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>styled</code> hook to customize the component the way you
            want it.
          </Typography>
          <AccordionCustomized />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            In order to put an action such as a Checkbox or a button inside{' '}
            <code>AccordionSummary</code>, you need to stop the propagation of
            the focus and click events to prevent the accordion from
