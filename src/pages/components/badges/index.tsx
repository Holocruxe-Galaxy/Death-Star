  ...
  return (
    <Grid container spacing={6} className="match-height">
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>badgeContent</code> prop for the text inside the badge and{' '}
            <code>color</code> prop for different colors of a badge.
          </Typography>
          <BadgesBasic />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>anchorOrigin</code> prop to move the badge to any corner
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>overlap</code> prop to place the badge relative to the
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            The visibility of badges can be controlled using{' '}
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            If you want to use light variant of the badges, you need to use our
