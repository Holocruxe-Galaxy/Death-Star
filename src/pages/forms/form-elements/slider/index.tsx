  ...
  return (
    <Grid container spacing={6} className="match-height">
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>defaultValue</code> prop for default slider value and{' '}
            <code>disabled</code> prop for disabled slider.
          </Typography>
          <SliderBasic />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            ...
            controlled slider and use <code>defaultValue</code> prop for
            uncontrolled slider.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            You can change the default step increment with <code>step</code>{' '}
            prop.
          </Typography>
          <SliderSmallSteps />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            ...
            supplying an array of values to the <code>value</code> or{' '}
