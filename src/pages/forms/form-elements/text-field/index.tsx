  ...
  return (
    <Grid container spacing={6} className="match-height">
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>variant={`{'filled' | 'standard'}`}</code> prop for
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            ...
            <code>disabled</code>, <code>type</code>, etc. as well as{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            ...
            controlled <code>TextField</code> and use
            <code>defaultChecked</code> prop for uncontrolled{' '}
            <code>TextField</code>.
          </Typography>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            The main way is with an <code>InputAdornment</code>. This can be
            used to add a prefix, a suffix or an action to an input. For
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            <code>fullWidth</code> can be used to make the input take up the
            full width of its container.
          </Typography>
          <Typography sx={{ mb: 4 }}>
            <code>margin</code> prop can be used to alter the vertical spacing
            of inputs. Using <code>none</code> (default) doesn't apply margins
            to the <code>FormControl</code> whereas <code>dense</code> and{' '}
            <code>normal</code> do.
          </Typography>
          <TextFieldLayout />
        </CardSnippet>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            ...
            <code>helperText</code> prop can then be used to provide feedback to
