  ...
  return (
    <Grid container spacing={6} className="match-height">
      <Grid item xs={12}>
        ...
        >
          <Typography>
            ...
            <code>TextField</code> component in <code>renderInput</code> prop
            with <code>Autocomplete</code> component for different variants of
            input. Use <code>disabled</code> prop with <code>Autocomplete</code>{' '}
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>value</code> prop with <code>Autocomplete</code> component
            for controlled autocomplete input.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>Checkbox</code> component in <code>renderOption</code>{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>filterOptions</code> prop to filter the search according
            to your needs.
          </Typography>
