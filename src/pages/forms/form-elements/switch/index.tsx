  ...
  return (
    <Grid container spacing={6} className="match-height">
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            ...
            controlled <code>Switch</code> and use
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>color</code> prop with <code>Switch</code> component for
            different colored switch.
          </Typography>
          <SwitchesColors />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>size='small'</code> prop with <code>Switch</code>{' '}
