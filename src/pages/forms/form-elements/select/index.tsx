  ...
  return (
    <Grid container spacing={6} className="match-height">
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            ...
            <code>FormControl</code> component for different variants of select
            and use <code>MenuItem</code> component as children of{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use <code>native</code> prop with <code>Select</code> component and{' '}
            <code>&lt;option&gt;</code> element inside <code>Select</code>{' '}
            component for native select.
          </Typography>
          <SelectNative />
        </CardSnippet>
      </Grid>
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>displayEmpty</code>, <code>disabled</code>,{' '}
            <code>error</code>, <code>renderValue</code>, <code>autoWidth</code>
            , <code>required</code> & <code>inputProps</code> props and{' '}
            <code>FormHelperText</code> component for different types of
            selects.
          </Typography>
          <SelectProps />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            ...
            controlled <code>Select</code> and use <code>defaultValue</code>{' '}
            prop for uncontrolled <code>Select</code>.
          </Typography>
          ...
          <Grid item xs={12}>
            ...
            >
              <Typography>
                ...
                or the native <code>&lt;optgroup&gt;</code> element.
              </Typography>
              <SelectGrouping />
            </CardSnippet>
          </Grid>
