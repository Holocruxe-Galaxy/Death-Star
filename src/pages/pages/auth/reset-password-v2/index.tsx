...
const ResetPasswordV2 = () => {
  ...
  const imageSource =
    skin === 'bordered'
      ? 'auth-v2-reset-password-illustration-bordered'
      : 'auth-v2-reset-password-illustration';
      ...
      {!hidden ? (
        ...
        >
          ...
          <FooterIllustrationsV2
            image={`/images/pages/auth-v2-reset-password-mask-${theme.palette.mode}.png`}
          />
        </Box>
      ) : null}
      <RightWrapper
...
ResetPasswordV2.getLayout = (page: ReactNode) => (
