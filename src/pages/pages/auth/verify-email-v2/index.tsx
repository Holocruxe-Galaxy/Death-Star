...
const VerifyEmailV2 = () => {
  ...
  const imageSource =
    skin === 'bordered'
      ? 'auth-v2-verify-email-illustration-bordered'
      : 'auth-v2-verify-email-illustration';
          ...
          <BoxWrapper>
            ...
            <Box sx={{ mb: 8 }}>
              ...
              <Typography sx={{ color: 'text.secondary' }}>
                ...
                <strong>john.doe@email.com</strong> Please follow the link
                inside to continue.
              </Typography>
            </Box>
...
VerifyEmailV2.getLayout = (page: ReactNode) => (
