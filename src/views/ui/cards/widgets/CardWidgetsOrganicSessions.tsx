        ...
        >
          ...
          <Box
            sx={{
              ...
              '& svg': {
                mr: 1.25,
                color: hexToRGBA(theme.palette.warning.main, 0.8),
              },
            }}
          >
            <Icon icon="mdi:circle" fontSize="0.75rem" />
          ...
          <Box
            sx={{
              ...
              '& svg': {
                mr: 1.25,
                color: hexToRGBA(theme.palette.warning.main, 0.6),
              },
            }}
          >
            <Icon icon="mdi:circle" fontSize="0.75rem" />
          ...
          <Box
            sx={{
              ...
              '& svg': {
                mr: 1.25,
                color: hexToRGBA(theme.palette.warning.main, 0.4),
              },
            }}
          >
            <Icon icon="mdi:circle" fontSize="0.75rem" />
          ...
          <Box
            sx={{
              ...
              '& svg': {
                mr: 1.25,
                color: hexToRGBA(theme.palette.warning.main, 0.2),
              },
            }}
          >
            <Icon icon="mdi:circle" fontSize="0.75rem" />
