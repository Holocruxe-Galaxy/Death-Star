    ...
    >
      ...
      >
        <img
          ...
          alt={`tabs-${category}`}
          src={`/images/logos/${
            category === 'facebook' ? 'facebook-round' : category
          }.png`}
        />
        <Typography
          variant="body2"
      ...
      <TabContext value={value}>
        ...
        >
          <Tab
            value="google"
            sx={{ p: 0 }}
            label={<RenderTabAvatar category="google" />}
          />
          <Tab
            value="facebook"
            sx={{ p: 0 }}
            label={<RenderTabAvatar category="facebook" />}
          />
          <Tab
            value="instagram"
            sx={{ p: 0 }}
            label={<RenderTabAvatar category="instagram" />}
          />
          <Tab
            value="reddit"
            sx={{ p: 0 }}
            label={<RenderTabAvatar category="reddit" />}
          />
          <Tab
            disabled
            value="add"
